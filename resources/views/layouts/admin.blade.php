...
<!-- jQuery -->
<script src="{{asset('/js-2/libs/jquery.js')}}"></script>
<script src="{{asset('/js-2/libs/bootstrap.js')}}"></script>
<script src="{{asset('/js-2/libs/metisMenu.js')}}"></script>
<script src="{{asset('/js-2/libs/sb-admin-2.js')}}"></script>
<script src="{{asset('/js-2/libs/scripts.js')}}"></script>
